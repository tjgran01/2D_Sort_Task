...
IL_006d:
		{
			KeyValuePair_2_t1A58906CCD7ED79792916B56DB716477495C85D8  L_14 = Enumerator_get_Current_mBEC9B470213860581893E0F197CAAE657B8B6C69_inline((Enumerator_tEE17C0B6306B38B4D74140569F93EA8C3BDD05A3 *)(&V_2), /*hidden argument*/Enumerator_get_Current_mBEC9B470213860581893E0F197CAAE657B8B6C69_RuntimeMethod_var);
			V_3 = L_14;
			UnityWebRequest_t9120F5A2C7D43B936B49C0B7E4CA54C822689129 * L_15 = __this->get__uwr_0();
			String_t* L_16 = KeyValuePair_2_get_Key_m1960AEAA9CE1FE1F69994434FFEAE113BD3AB3C7_inline((KeyValuePair_2_t1A58906CCD7ED79792916B56DB716477495C85D8 *)(&V_3), /*hidden argument*/KeyValuePair_2_get_Key_m1960AEAA9CE1FE1F69994434FFEAE113BD3AB3C7_RuntimeMethod_var);
			String_t* L_17 = KeyValuePair_2_get_Value_mEAF4B15DEEAC6EB29683A5C6569F0F50B4DEBDA2_inline((KeyValuePair_2_t1A58906CCD7ED79792916B56DB716477495C85D8 *)(&V_3), /*hidden argument*/KeyValuePair_2_get_Value_mEAF4B15DEEAC6EB29683A5C6569F0F50B4DEBDA2_RuntimeMethod_var);
			UnityWebRequest_SetRequestHeader_m1B54D38BDACC2789FC8EE889EA72EDD7844D2309(L_15, L_16, L_17, /*hidden argument*/NULL);
		}

IL_008f:
		{
			bool L_18 = Enumerator_MoveNext_m6E6A22A8620F5A5582BB67E367BE5086D7D895A6((Enumerator_tEE17C0B6306B38B4D74140569F93EA8C3BDD05A3 *)(&V_2), /*hidden argument*/Enumerator_MoveNext_m6E6A22A8620F5A5582BB67E367BE5086D7D895A6_RuntimeMethod_var);
			if (L_18)
			{
				goto IL_006d;
			}
...
IL_0019:
	{
		Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC * L_3 = __this->get__responseHeaders_1();
		V_2 = (bool)((((RuntimeObject*)(Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC *)L_3) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_4 = V_2;
		if (!L_4)
		{
			goto IL_0094;
	...
	}
	{
		...
		Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC * L_6 = UnityWebRequest_GetResponseHeaders_mFA5C7C10F2BA83F21826611AF204BC56E881A863(L_5, /*hidden argument*/NULL);
		__this->set__responseHeaders_1(L_6);
		Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC * L_7 = __this->get__responseHeaders_1();
		V_3 = (bool)((!(((RuntimeObject*)(Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC *)L_7) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
		bool L_8 = V_3;
		if (!L_8)
		{
			goto IL_0088;
	...
	{
		UnityWebRequest_t9120F5A2C7D43B936B49C0B7E4CA54C822689129 * L_9 = __this->get__uwr_0();
		int64_t L_10 = UnityWebRequest_get_responseCode_m34819872549939D1EF9EA3D4010974FBEBAF0070(L_9, /*hidden argument*/NULL);
		String_t* L_11 = UnityWebRequest_GetHTTPStatusString_m370515E94B5B3C14B4A49677A31D8494262D7EDA(L_10, /*hidden argument*/NULL);
		V_4 = L_11;
		Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC * L_12 = __this->get__responseHeaders_1();
		UnityWebRequest_t9120F5A2C7D43B936B49C0B7E4CA54C822689129 * L_13 = __this->get__uwr_0();
		int64_t L_14 = UnityWebRequest_get_responseCode_m34819872549939D1EF9EA3D4010974FBEBAF0070(L_13, /*hidden argument*/NULL);
		int64_t L_15 = L_14;
		RuntimeObject * L_16 = Box(Int64_t7A386C2FF7B0280A0F516992401DDFCF0FF7B436_il2cpp_TypeInfo_var, &L_15);
		String_t* L_17 = V_4;
		String_t* L_18 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral4DD76F7BD318A8B909BC0FF86CA3BE3625DA0374, L_16, L_17, /*hidden argument*/NULL);
		Dictionary_2_set_Item_m597918251624A4BF29104324490143CFCA659FAD(L_12, _stringLiteral7168833CC8E158CFE68927F52FC70F5A6A7F27AE, L_18, /*hidden argument*/Dictionary_2_set_Item_m597918251624A4BF29104324490143CFCA659FAD_RuntimeMethod_var);
		goto IL_0093;
	}
...
IL_0088:
	{
		...
		__this->set__responseHeaders_1(L_19);
	}
...
IL_0094:
	{
		Dictionary_2_t931BF283048C4E74FC063C3036E5F3FE328861FC * L_20 = __this->get__responseHeaders_1();
		V_1 = L_20;
		goto IL_009d;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR float WWW_get_uploadProgress_m64B269EE2BD19A75A1CF165BA2A6712B49089D96 (WWW_tA50AFB5DE276783409B4CE88FE9B772322EE5664 * __this, const RuntimeMethod* method)
{
	...
	{
		UnityWebRequest_t9120F5A2C7D43B936B49C0B7E4CA54C822689129 * L_0 = __this->get__uwr_0();
		float L_1 = UnityWebRequest_get_uploadProgress_mA63D1BC81FCDED0715D033DB7493CDD74E732AB0(L_0, /*hidden argument*/NULL);
		V_0 = L_1;
		float L_2 = V_0;
